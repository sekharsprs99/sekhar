#!/bin/bash
export OS_TOKEN='a67cd93821e12efc82c1'
...
then
    ...
    openstack user create --domain default --password test123 admin
fi
...
then
    ...
    openstack user create --domain default  --password test123 demo
fi
...
then
    ...
    openstack user create --domain default --password test123 glance
fi
...
then
    ...
    openstack user create --domain default  --password test123  nova
fi
...
then
    ...
    openstack user create --domain default --password test123 neutron
fi
